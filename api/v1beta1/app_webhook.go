...
//+kubebuilder:webhook:path=/mutate-ingress-gientech-com-v1beta1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=ingress.gientech.com,resources=apps,verbs=create;update,versions=v1beta1,name=mapp.kb.io,admissionReviewVersions=v1
...
func (r *App) Default() {
	...
	applog.Info("update before", "EnableIngress", r.Spec.EnableIngress)
	r.Spec.EnableIngress = !r.Spec.EnableIngress
	applog.Info("update after", "EnableIngress", r.Spec.EnableIngress)
}

// TODO(user): change verbs to "verbs=create;update;delete" if you want to enable deletion validation.
//+kubebuilder:webhook:path=/validate-ingress-gientech-com-v1beta1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=ingress.gientech.com,resources=apps,verbs=create;update,versions=v1beta1,name=vapp.kb.io,admissionReviewVersions=v1
